...
ActiveRecord::Schema.define(version: 2019_08_23_101511) do
  ...
  create_table "entrepreneurs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "business_summary"
    t.string "funding_purpose"
    t.string "location"
  end
  ...
  create_table "investments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["entrepreneur_id"], name: "index_investments_on_entrepreneur_id"
  ...
  add_foreign_key "investments", "entrepreneurs"
